...
JoinChannel = true
local url , res = https.request('https://api.telegram.org/bot/getchatmember?chat_id=@EinoTeam&user_id='..msg.sender.user_id)
...
type = 'inline',
data = {
{{text = '⌔ 𝖲𝗈𝗎𝗋𝖼𝖾 𝖤𝗂𝗇𝗈',url="t.me/EinoTeam"}},
}
}
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '⌁︙ 𝖲𝗈𝗎𝗋𝖼𝖾 𝖤𝗂𝗇𝗈', url = 't.me/EinoTeam'}, },}}
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/EinoTeam&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعه" then
...
local UserId_Info = bot.searchPublicChat("ddbddd")
if UserId_Info.id then
...
local Text = "*ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ 𝖤𝗂𝗇𝗈\n\n*[⌔  𝖤𝗂𝗇𝗈 ᴄʜᴀɴɴᴇʟ](http://t.me/EinoTeam)*\n\n*[⌔  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/EinoTeam)*\n\n*[⌔  𝖤𝗂𝗇𝗈 ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/ddbddd)*\n\n*[⌔  ʙᴏᴛ 𝖤𝗂𝗇𝗈](http://t.me/EinoTwsbot)*\n*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝖲𝗈𝗎𝗋𝖼𝖾 𝖤𝗂𝗇𝗈 ',url="t.me/EinoTeam"}
...
if text == 'تيست' then 
if ChannelJoin(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'قناة السورس', url = 't.me/EinoTeam'}, },}}
return bot.sendText(msg.chat_id,msg.id,'*\n￤عذراً ، عليك الأشتراك في قناة البوت أولاً ،*',"md",false, false, false, false, reply_markup)
end
